  ...
  return (
    <div className="language-switcher-container" ref={dropdownRef} style={{ position: 'relative', display: 'inline-block' }}>
      ...
      >
        ...
        <span style={{ fontWeight: 500 }}>English (Global)</span>
          ...
          {languages.map((lang, index) => (
            <button
              ...
              style={{
                ...
                color: lang.code === 'en' ? 'var(--ms-blue)' : 'var(--ms-text-main)',
                fontSize: '0.85rem',
                fontWeight: lang.code === 'en' ? '600' : '400',
                cursor: 'pointer',
            ...
            >
              ...
              {lang.code !== 'en' && <span style={{ fontSize: '0.65rem', color: 'var(--ms-mid-gray)', background: 'var(--ms-bg-main)', padding: '2px 8px', borderRadius: '100px', border: '1px solid var(--ms-border)', fontWeight: 600 }}>Soon</span>}
              {lang.code === 'en' && <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>}
            </button>
          ))}
        </div>
      )}
